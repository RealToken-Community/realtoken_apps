...
class ToolsPage extends StatelessWidget {
        ...
        for (var transaction in token['transactions']) {
          if (transaction['dateTime'] != null) {
            ...
            events.add({
              ...
              'price': currencyUtils
                  .convert(transaction['price'] ?? token['tokenPrice']),
  ...
  String _generateAllEventsCSV(List<Map<String, dynamic>> events) {
    ...
    for (var event in events) {
      ...
      csvBuffer.writeln(
          '$date,$type,$amount,$price,$currency,$fullName,$uuid,$transactionType');
    }
    return csvBuffer.toString();
  }
}
