...
class ChartUtils {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            _buildPeriodButton(
                S.of(context).day, context, selectedPeriod, onPeriodChanged),
            _buildPeriodButton(
                S.of(context).week, context, selectedPeriod, onPeriodChanged),
            _buildPeriodButton(
                S.of(context).month, context, selectedPeriod, onPeriodChanged),
            _buildPeriodButton(
                S.of(context).year, context, selectedPeriod, onPeriodChanged),
          ],
        ),
      ),
    );
  ...
  static Widget _buildPeriodButton(String period, BuildContext context,
      String selectedPeriod, Function(String) onPeriodChanged) {
  ...
  static List<FlSpot> buildHistoryChartData<T>(
      ...
      {bool applyStep = true,
      String aggregate = "average"} // Ajout du paramètre aggregate
      ) {
